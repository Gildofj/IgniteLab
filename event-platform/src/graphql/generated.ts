...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, title: string, slug?: string | null, availableAt?: any | null, lessonType: LessonType }> };
